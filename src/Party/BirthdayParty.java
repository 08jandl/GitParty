...
public class BirthdayParty {
    ...
    private static void simplePartyScenario (String partyScenario2, boolean cake, boolean frenchFries, boolean chickenNuggets, boolean fruits, boolean spaghetti, boolean burger, boolean balloons, boolean candles, boolean confetti, boolean drinks) {
        if ( (cake && drinks) && ( (frenchFries || chickenNuggets) || (fruits && spaghetti || burger)) && (balloons || candles || confetti)) {
            System.out.println(partyScenario2);
        }
    }
}
